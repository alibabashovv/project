        ...
        public static void Creategroup()
        {
...

            {
                ...
                if (categoryResult)
                {
                    ...
                    {
                        case 1:
                            string No = courseservice.Creategroup(groupno, Professioncategory.Programming);
                            Console.WriteLine($"{No} Group succesfully created");
                            break;
                        case 2:
                            No = courseservice.Creategroup(groupno, Professioncategory.Design);
                            Console.WriteLine($"{No} Group succesfully created");
                            break;
                        case 3:
                            No = courseservice.Creategroup(groupno, Professioncategory.SystemAdministration);
                            Console.WriteLine($"{No} Group succesfully created");
                            break;
                        default:
                            break;
