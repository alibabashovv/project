...
namespace Coursemanagement.Service
{
    class Courseservice : Icourseservice
    {
        ...
        {
            foreach (Student student in _groups)
            {
        ...
        public string Creategroup(int numberofstudent, int groupnumber, Professioncategory category)
        {
            if (numberofstudent <= 0)
            {
                return "Please enter correctly numbers of students";
            }

            Group group = new Group(groupnumber, numberofstudent, category);
        ...
        public string Createstudent(string fullname, int groupno, string Istype, int age)
        {
            if (age <= 0)
            {
                return "Please enter valid number";
            }
            Student student = new Student(fullname, groupno, Istype);
